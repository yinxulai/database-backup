...
## TASK-0007 | IN_PROGRESS | 实现备份验证 Dry Run
- owner: (none)
- summary: 实现备份上传前的 dry-run 验证，确保 dump 可读
- updatedAt: 2026-04-18T04:54:14.819Z
- roadmapRefs: (none)
- links:
  - (none)
...
- links:
  - (none)
## TASK-0006 | TODO | 实现 Prometheus Metrics 上报
- owner: (none)
- summary: 实现 Prometheus 指标上报，支持备份成功/失败/耗时/大小等指标
- updatedAt: 2026-04-18T04:35:30.316Z
- roadmapRefs: (none)
- links:
  - (none)
## TASK-0005 | TODO | 实现备份恢复功能
- owner: (none)
- summary: 实现 pg_restore 备份恢复，支持指定时间点恢复
- updatedAt: 2026-04-18T04:35:21.382Z
- roadmapRefs: (none)
- links:
  - (none)
